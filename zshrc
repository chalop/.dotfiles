...
alias bend="code src/resolvers/Query.js src/schema.graphql"
...
# taken from https://blog.mattclemente.com/2020/06/26/oh-my-zsh-slow-to-load/
timezsh() {
  shell=${1-$SHELL}
...
#figlet -f drpepper No One Cares
#echo 👀 👀 👀 👀 👀 👀 👀 👀 👀
#pfetch
